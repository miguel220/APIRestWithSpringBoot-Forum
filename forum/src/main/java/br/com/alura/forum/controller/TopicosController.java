...
public class TopicosController {
	...
	@GetMapping
	@ApiOperation(value = "Retorna uma lista de topicos do forum")
	...
	@PostMapping
	@ApiOperation(value = "Cadastra um um novo topico")
	...
	@GetMapping("/{id}")
	@ApiOperation(value = "Retorna um topico detalhadamente")
	...
	@PutMapping("/{id}")
	@ApiOperation(value = "Atualiza um topico")
	@Transactional
	...
	@DeleteMapping("/{id}")
	@ApiOperation(value = "Deleta um topico")
	@Transactional
